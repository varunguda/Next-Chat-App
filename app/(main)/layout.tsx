        ...
        <nav className="flex flex-1 flex-col">
          <ul role="list" className="flex flex-1 flex-col gap-y-7">
                ...
                {sidebarOptions.map((option) => {
                  ...
                  return (
                    <li key={option.id}>
                      <Link
                        href={option.href}
                        className="text-gray-700 hover:bg-gray-50 group hover:text-secondaryRed flex gap-3 rounded-md p-2 text-sm leading-6 font-semibold"
                      >
            ...
            <li className="-mx-6 mt-auto flex items-center">
              <div className="flex flex-1 justify-between align-middle px-1 py-3 text-sm font-semibold leading-6 text-gray-900">
